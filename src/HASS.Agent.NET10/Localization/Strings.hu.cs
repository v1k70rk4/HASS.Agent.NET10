...
internal static partial class Strings
{
    private static readonly Dictionary<string, string> Hu = new()
    {
            ...
            ["Attribute.address"] = "Cím",
            ["Attribute.apps"] = "Alkalmazások",
            ["Attribute.away_mode_required"] = "Távolléti mód kérve",
            ["Attribute.blocking"] = "Blokkol",
            ["Attribute.category"] = "Kategória",
            ["Attribute.created_at"] = "Időpont",
            ["Attribute.description"] = "Leírás",
            ["Attribute.display_required"] = "Kijelző kérve",
            ["Attribute.event_id"] = "Eseményazonosító",
            ["Attribute.height"] = "Magasság",
            ["Attribute.level"] = "Szint",
            ["Attribute.log"] = "Napló",
            ["Attribute.message"] = "Üzenet",
            ["Attribute.name"] = "Név",
            ["Attribute.primary"] = "Elsődleges",
            ["Attribute.primary_blocker"] = "Fő blokkoló",
            ["Attribute.provider"] = "Forrás",
            ["Attribute.reason"] = "Ok",
            ["Attribute.system_required"] = "Rendszer kérve",
            ["Attribute.type"] = "Típus",
            ["Attribute.width"] = "Szélesség",
            ["Attribute.window_minutes"] = "Időablak (perc)",
            ["Attribute.x"] = "X",
            ["Attribute.y"] = "Y",
            ["Attribute.source"] = "Forrás",
            ["Attribute.kind"] = "Fajta",
            ["Attribute.duration_seconds"] = "Időtartam (mp)",
            ["Attribute.sleep_entered"] = "Alvásba lépett",
            ["Attribute.detail"] = "Részlet",
            ["Attribute.3d"] = "3D",
            ["Attribute.videodecode"] = "Videódekódolás",
            ["Attribute.videoencode"] = "Videókódolás",
            ["Attribute.npu_usage"] = "NPU-használat",
            ["Attribute.memory_dedicated_mb"] = "Dedikált memória (MB)",
            ["Attribute.memory_shared_mb"] = "Megosztott memória (MB)",
            ["Attribute.memory_mb"] = "Memória (MB)",
            ...
            ["Sensor.sleep_blocked"] = "Alvás blokkolva",
            ["Sensor.gpu_usage"] = "GPU-használat",
            ...
            ["Sensor.last_wake_reason"] = "Utolsó ébredés oka",
